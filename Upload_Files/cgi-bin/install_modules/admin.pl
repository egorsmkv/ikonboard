...
sub process {
    ...
    unless (length ($iB::CGI->param('MEMBER_PASSWORD')) >= 5 ) {
        push @errors, "The password entered is too short. The minimum length is 5 characters";
    }
...
sub form {
	...
	<td colspan='2' class='t'>
		<b>Password alert:</b> Avoid using non-alphanumerical characters in your password as this can cause problems later.
	</td>
	</tr>
             <tr>
