...
sub process {
    ...
    # Database: Happy Birthday Template
    open (FILE, "$iB::INFO->{'IKON_DIR'}INSTALL_DATA/happybd_template.txt") or &iB::install_error( "Cannot open /INSTALL_DATA/happybd_template.txt" );
    my @news = <FILE>;
    close FILE;
    ...
    # Database: Welcome PM Template
    open (FILE, "$iB::INFO->{'IKON_DIR'}INSTALL_DATA/welcome_template.txt") or &iB::install_error( "Cannot open /INSTALL_DATA/welcome_template.txt" );
    my @news = <FILE>;
    close FILE;
